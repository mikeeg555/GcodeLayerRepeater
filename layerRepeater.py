...
def main(filename, layerToRepeat, numReps):
    ...
    print(f"Layer {layerToRepeat} to be repeated {numReps} times. adding total {deltaZmm} mm to model.")
    lineCount=0
    layerCount=0
    ...
    absExtAmount = 0.0
    lineNum = lastExtruderResetLine + 1
    ...
    print(f"Total lines modified: {linesChanged}")
